...
public class RateLimiter {
     ...
     * 分布式同步锁
     */
    private IRedissonDistributedLock syncLock;

    public RateLimiter(String key, Double permitsPerSecond, Integer maxBurstSeconds, IRedissonDistributedLock syncLock){
        this.key = key;
